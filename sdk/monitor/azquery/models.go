...
type AdditionalInfoErrorResponse struct {
	...
	Error *AdditionalInfoErrorResponseError `json:"error,omitempty"`
}
...
type AdditionalInfoErrorResponseError struct {
	...
	AdditionalInfo []*AdditionalInfoErrorResponseErrorAdditionalInfoItem `json:"additionalInfo,omitempty"`
}
...
// MetadataValueAutoGenerated - Represents a metric metadata value.
type MetadataValueAutoGenerated struct {
	// The name of the metadata.
...
// MetricAutoGenerated - The result data of a query.
type MetricAutoGenerated struct {
	...
	// REQUIRED; The time series returned when a data query is performed.
	TimeSeries []*TimeSeriesElementAutoGenerated `json:"timeseries,omitempty"`
...
type MetricResultsResponse struct {
	...
	Values []*MetricResultsResponseValuesItem `json:"values,omitempty"`
}
...
type MetricResultsResponseValuesItem struct {
	...
	Value []*MetricAutoGenerated `json:"value,omitempty"`
...
// MetricValueAutoGenerated - Represents a metric value.
type MetricValueAutoGenerated struct {
	// REQUIRED; The timestamp for the metric value in ISO 8601 format.
	TimeStamp *time.Time `json:"timeStamp,omitempty"`
...
// MonitorMetricsClientQueryBatchOptions contains the optional parameters for the MonitorMetricsClient.QueryBatch method.
type MonitorMetricsClientQueryBatchOptions struct {
	// The list of aggregation types to retrieve
	Aggregation []*AggregationType
...
// TimeSeriesElementAutoGenerated - A time series result type. The discriminator value is always TimeSeries in this case.
type TimeSeriesElementAutoGenerated struct {
	// An array of data points representing the metric values. This is only returned if a result type of data is specified.
	Data []*MetricValueAutoGenerated `json:"data,omitempty"`

	// The metadata values returned if filter was specified in the call.
	MetadataValues []*MetadataValueAutoGenerated `json:"metadatavalues,omitempty"`
}
