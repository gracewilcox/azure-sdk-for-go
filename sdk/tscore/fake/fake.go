...
// AddResponseError adds an *tscore.ResponseError to the sequence of responses.
// The error is returned from the call to runtime.Pager[T].NextPage().
...
// SetTerminalError sets an *tscore.ResponseError with the specified values as the failed terminal response.
